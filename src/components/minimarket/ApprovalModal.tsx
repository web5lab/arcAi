...
export function ApprovalModal({ isOpen, onClose, onSuccess, token, spender }: ApprovalModalProps) {
  const { theme } = useTheme();
  const [status, setStatus] = useState<'initial' | 'pending' | 'success'>('initial');
