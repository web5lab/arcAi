...
interface MarketHeaderProps {
  ...
  sortBy: 'newest' | 'price' | 'volume';
  onSortChange: (sort: 'newest' | 'price' | 'volume') => void;
  orderType: 'all' | 'buy' | 'sell';
  onOrderTypeChange: (type: 'all' | 'buy' | 'sell') => void;
}
            ...
            `}>
              {[
                ...
                <button
                  key={option.id}
                  onClick={() => {
                    onSortChange(option.id as typeof sortBy);
            ...
            `}>
              {['all', 'buy', 'sell'].map((type) => (
                <button
                  key={type}
                  onClick={() => {
                    onOrderTypeChange(type as typeof orderType);
